...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/Sharp-Mind/3x-ui-alternate/master/install.sh"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/Sharp-Mind/3x-ui-alternate/master/install.sh)${plain}"
    echo ""
